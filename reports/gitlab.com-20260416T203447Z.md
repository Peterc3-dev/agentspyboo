...
**Date:** 2026-04-16T20:34:47.453334546+00:00  
**Model:** qwen3:8b  
**Iterations:** 3  
...
Subfinder found 536 subdomains, but httpx failed due to invalid arguments. Assessment chain terminated. Verify httpx usage: https://github.com/projectdiscovery/httpx
...
**Mode:** passive  
**Runtime:** 121.6s  
**Plugins fired:** asn-bgp, github-org, gleif, urlscan, wayback  
**Records:** 16 raw, 8 filtered out
...
_Dedup folded 537 raw observations into 2 grouped findings. Disable with `--no-dedup`._
...
| 2 | ℹ️ info | subdomain | 536 targets (x536) | discovered via subfinder |

<details><summary>Finding #2 — 536 target(s)</summary>
...
**Error:** unparseable; retry requested

### Iteration 2 — subfinder
...
**Error:** httpx exited Some(2): Usage: httpx [OPTIONS] URL
...
- Validate httpx command syntax
- Manually check live subdomains
- Reattempt with corrected parameters
